      ...
      <div className="container px-4 md:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-dim max-w-2xl mx-auto">
            Ready to bring your vision to life? Send me a message and let's start building something amazing.
          </p>
        </div>
          ...
          >
            ...
            <div className="flex flex-col gap-8">
              <div className="flex items-center gap-6 group">
                <div className="w-14 h-14 glass flex items-center justify-center rounded-2xl border-primary/20 group-hover:bg-primary/10 transition-all">
                  <Mail className="text-primary" size={24} />
                </div>
                <div>
                  <p className="text-dim text-sm uppercase tracking-wider mb-1">Email Us</p>
                  <p className="text-xl font-medium">info@inkwellcode.com</p>
                </div>
              </div>
              <div className="flex items-center gap-6 group">
                <div className="w-14 h-14 glass flex items-center justify-center rounded-2xl border-primary/20 group-hover:bg-primary/10 transition-all">
                ...
                <div>
                  <p className="text-dim text-sm uppercase tracking-wider mb-1">Call Us</p>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <p className="text-dim text-sm uppercase tracking-wider mb-1">Visit Studio</p>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <input 
                      ...
                      className="glass bg-bg-dark/50 p-3 rounded-lg border-white/10 focus:border-primary outline-none transition-all"
                      value={formData.name}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select 
                    className="glass bg-bg-dark/50 p-3 rounded-lg border-white/10 focus:border-primary outline-none transition-all appearance-none"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea 
                    ...
                    className="glass bg-bg-dark/50 p-3 rounded-lg border-white/10 focus:border-primary outline-none transition-all resize-none"
